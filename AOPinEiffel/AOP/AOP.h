...
/* [detachable] EVENT_HANDLERS [[attached] TUPLE [[attached] STRING_8]] */
...
/* Struct for type [detachable] EVENT_HANDLERS [[attached] TUPLE [[attached] STRING_8]] */
struct S77 {
	EIF_TYPE_INDEX id;
	uint16_t flags;
	T1 a1; /* in_operation */
	T0* a2; /* area_v2 */
	T0* a3; /* kamikazes_internal */
	T6 a4; /* state */
	T1 a5; /* object_comparison */
	T6 a6; /* index */
...
extern void T77f33(GE_context* ac, T0* C, T0* a1);
...
extern T6 T77f15(GE_context* ac, T0* C);
/* [detachable] EVENT_HANDLERS [[attached] TUPLE [[attached] STRING_8]].extend */
...
extern T6 T77f16(GE_context* ac, T0* C);
/* INTEGER_32.max */
...
extern void T77f27(GE_context* ac, T0* C);
/* [detachable] EVENT_HANDLERS [[attached] TUPLE [[attached] STRING_8]].arrayed_list_make */
extern void T77f30(GE_context* ac, T0* C, T6 a1);
...
extern void T77f32(GE_context* ac, T0* C, T0* a1, T6 a2);
/* [detachable] EVENT_HANDLERS [[attached] TUPLE [[attached] STRING_8]].on_item_removed_at */
extern void T77f34(GE_context* ac, T0* C, T0* a1, T6 a2);
...
extern T0* T77f13(GE_context* ac, T0* C);
/* [detachable] ACTION_CELL [[attached] STRING_8].put */
